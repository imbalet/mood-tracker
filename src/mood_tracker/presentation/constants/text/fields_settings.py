...
_TEXTS: dict[TextKey, str] = {
    ...
    TextKey.ADD_FROM_QUESTIONNAIRE: "Добавить из другой анкеты",
    TextKey.QUESTIONNAIRES_TITLE: "<b>Анкеты</b>",
    TextKey.DIARY: "Дневник",
    TextKey.EVENTS: "События",
    TextKey.CREATE_FIELD_TYPE: "Какой тип поля добавить?",
    TextKey.FIELD_TYPE_SCALE: "Числовая шкала",
    TextKey.FIELD_TYPE_SCALE_SHORT: "Шкала",
    TextKey.FIELD_TYPE_ORDINAL: "Упорядоченные варианты",
    TextKey.FIELD_TYPE_ORDINAL_SHORT: "Варианты",
